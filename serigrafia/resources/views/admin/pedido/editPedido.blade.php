                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="border px-2 py-2">
                                <a class="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-32 border-b-4 border-blue-700 hover:border-blue-500 rounded" href="{{route('pedidos.addPro_Ped', $pedido->id)}}">
                                    Agregar Producto
                                </a>
                            </td>
                        </tr>

...
<header class="interfaz_Principal">
    ...
    <h1 style="font-size: 30px;" class="font-extrabold  pl-16 ">Agregar Pedido</h1>
    <br>
    <br>
...
<form action="{{route('pedidos.save2')}}" method="post" enctype="multipart/form-data" class="p-4">
    @csrf
            ...
            $('#productsTableBody').append(
                "<tr class='flex flex-wrap sm:table-row mb-6 sm:mb-0'>"
                    ...
                    +"<td class='w-1/2 sm:w-auto p-3 text-right sm:text-center border border-b-0 sm:border-none rounded-tr-lg sm:rounded-tr-none'>"
                        +"<input type='hidden' name='productos["+producto.value+"][id]' value='"+producto.value+"' class='idProductos'>"
            ...
            Swal.fire(
                {
                    ...
                    text: 'Te recomendamos buscarlo en la tabla y sólo editar la cantidad asignada',

@extends('layouts.app')
@section('content')
<form action="{{route('cliente.carrito.carritoPedido')}}" method="post">
    @csrf
    <div class="w-full justify-center">
        <h1 class="text-center text-2xl">Carrito de </h1>
        <h2 class="text-center text-2xl">{{auth()->user()->name}}</h2>
    </div>
    ...
    <div class="w-full">
        ...
        <div class="flex flex-row w-full pt-16 pl-10 text-center">
            ...
            <div class="w-1/5 text-left">
                <input type="date" name="FechaEntraga" id="fecha" class="">
            </div>
        </div>
        <div class="flex flex-row w-full pt-4 pl-10 pb-4">
            ...
            <div class="flex flex-row w-1/2">
                <button id="btnPagar" type="submit" class="ml-96 mr-8 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded">Pagar</button>
